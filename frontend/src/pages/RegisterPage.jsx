      ...
      >
        ...
        <button
          ...
          style={{
            ...
            padding: '11px', display: 'flex', alignItems: 'center', justifyContent: 'center',
            gap: '10px', fontSize: '14px', fontWeight: 500, cursor: 'pointer',
            marginBottom: '1.2rem', color: '#1a1a1a', fontFamily: 'DM Sans, sans-serif',
          }}
        >
